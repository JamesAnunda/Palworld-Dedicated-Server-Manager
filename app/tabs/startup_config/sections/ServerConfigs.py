...
class ServerConfigs(TkViewElements.TkLabelFrame, ISavable, IRestorable):
    def __init__(self, startup_configs: 'StartupConfigs.StartupConfigs', settings_handler: 'SettingsHandler.SettingsHandler', label_text: str = "Server Configuration", column: int = 0, row: int = 1, sticky: tk.constants = tk.S):
        ...
        row = 0
        self.palworld_dir = tk.StringVar(value=self.settings_handler.palworld_directory.get())
        ...
        row += 1
        self.arrcon_dir = tk.StringVar(value=self.settings_handler.arrcon_directory.get())
        ...
        row += 1
        self.steamcmd_dir = tk.StringVar(value=self.settings_handler.steamcmd_directory.get())
        ...
        row += 1
        self.backup_dir = tk.StringVar(value=self.settings_handler.backup_directory.get())
    ...
    def save(self) -> None:
        self.settings_handler.palworld_directory.set(self.palworld_dir.get())
        self.settings_handler.arrcon_directory.set(self.arrcon_dir.get())
        self.settings_handler.steamcmd_directory.set(self.steamcmd_dir.get())
        self.settings_handler.backup_directory.set(self.backup_dir.get())
        self.settings_handler.server_start_args.set(self.server_start_args.get())

    def restore(self) -> None:
        self.palworld_dir.set(self.settings_handler.palworld_directory.get())
        self.arrcon_dir.set(self.settings_handler.arrcon_directory.get())
        self.steamcmd_dir.set(self.settings_handler.steamcmd_directory.get())
        self.backup_dir.set(self.settings_handler.backup_directory.get())
